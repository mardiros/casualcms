  ...
  return (
    <RequireAuth>
      <Routes>
        ...
        <Route path="pages/new/:pageTypeName" element={<PageNew />} caseSensitive />
        ...
        <Route path="snippets/new" element={<SnippetTypeList />} caseSensitive />
        <Route
        ...
        <Route path="settings/:hostname" element={<SettingList />} caseSensitive />
        <Route
