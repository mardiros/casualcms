...
export const SideBarItem: React.FunctionComponent<SideBarItemProps> = (
  ...
  return (
    <Box bg={colors[0]} borderRadius="md" color={colors[1]} margin={2} marginBottom={0}>
...
export const SideBar: React.FunctionComponent<{}> = () => {
  ...
  if (location.pathname.startsWith("/admin/pages") || location.pathname === "/admin/") {
  ...
  return (
    <Box minWidth={250} height="calc(100vh - 90px)" color="white">
      <SimpleGrid columns={1} spacing={1}>
        ...
        <SideBarItem colors={snippetsColor} href="/admin/snippets" title="Snippets" />
        <SideBarItem colors={sitesColor} href="/admin/sites" title="Sites" />
        <SideBarItem colors={settingsColor} href="/admin/settings" title="Settings" />
      </SimpleGrid>
    </Box>
  );
};
